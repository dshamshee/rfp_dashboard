...
export const STATE_DISTRICT_DATA: { states: StateDistrict[] } = {
  states: [
    {
      state: "Andhra Pradesh",
      districts: [
        "Alluri Sitharama Raju", "Anakapalli", "Ananthapuramu", "Annamayya", "Bapatla", 
        "Chittoor", "East Godavari", "Eluru", "Guntur", "Kakinada", "NTR", "Nandyal", 
    ...
    },
    {
      ...
      districts: [
        ...
        "Muzaffarpur", "Nalanda", "Nawada", "Patna", "Purnea", "Rohtas", "Saharsa", "Samastipur", 
    ...
    },
    {
      state: "Chhattisgarh",
      districts: [
        "Balod", "Baloda Bazar", "Balrampur-Ramanujganj", "Bestar", "Bemetara", "Bijapur", 
    ...
    },
    {
      ...
      districts: [
        ...
        "Jhabua", "Katni", "Khandwa", "Khargone", "Mandla", "Mandsaur", "Morena", "Mauganj", 
    ...
    },
    {
      state: "Odisha",
      districts: [
        "Anugul", "Balangir", "Baleshwar", "Bargarh", "Bhadrak", "Baudh", "Cuttack", "Debagarh", 
    ...
    },
    {
      ...
      districts: [
        ...
        "Didwana-Kuchaman", "Dholpur", "Dungarpur", "Ganganagar", "Gangapur City", "Hanumangarh", 
        "Jaipur", "Jaipur Rural", "Jaisalmer", "Jalore", "Jhalawar", "Jhunjhunu", "Jodhpur", 
        "Jodhpur Rural", "Karauli", "Kekri", "Kota", "Kotputli-Behror", "Nagaur", "Neem Ka Thana", 
        "Pali", "Phalodi", "Pratapgarh", "Rajsamand", "Salumbar", "Sanchi", "Sawai Madhopur", 
        "Shahpura", "Sikar", "Sirohi", "Tonk", "Udaipur"
      ]
    },
    {
      state: "Sikkim",
      districts: ["Gangtok", "Mangan", "Pakyong", "Soreng", "Gyalshing", "Namchi"]
    },
    {
      state: "Tamil Nadu",
      districts: [
    ...
    },
    {
      state: "Telangana",
      districts: [
        "Adilabad", "Bhadradri Kothagudem", "Hanamkonda", "Hyderabad", "Jtial", "Jangaon", 
    ...
    },
    {
      ...
      districts: [
        ...
        "Kolkata", "Maldah", "Murshidabad", "Nadia", "North 24 Parganas", "Paschim Medinipur", 
    ...
    .map((s) => ({
      ...s,
      districts: [...s.districts].sort((a, b) => a.localeCompare(b)),
    }))
